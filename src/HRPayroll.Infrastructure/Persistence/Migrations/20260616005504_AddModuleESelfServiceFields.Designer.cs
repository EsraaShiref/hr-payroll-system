...
namespace HRPayroll.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260616005504_AddModuleESelfServiceFields")]
    partial class AddModuleESelfServiceFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRPayroll.Domain.Entities.AttendanceDailySummary", b =>
                {
                    ...
                    b.Property<TimeOnly?>("DisputedPunchIn")
                        .HasColumnType("time");

                    b.Property<TimeOnly?>("DisputedPunchOut")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("HRPayroll.Domain.Entities.Employee", b =>
                {
                    ...
                    b.Property<bool>("IsEmailChangePending")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HRPayroll.Domain.Entities.PayrollPolicy", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("DefaultOvertimeRateMultiplier")
                        .HasColumnType("decimal(3,2)");
                    ...
                    b.Property<int>("LateOccurrencesThreshold")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRPayroll.Domain.Entities.PayrollRunDetail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("LateOccurrenceCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("LeaveBalanceSnapshotDays")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("NonTaxableAllowancesTotal")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("SocialInsuranceEmployerShare")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("PayrollRunDetails", (string)null);
                });
            ...
            modelBuilder.Entity("HRPayroll.Domain.Entities.PayrollRunDetail", b =>
                {
                    ...
                    b.HasOne("HRPayroll.Domain.Entities.PayrollRun", "PayrollRun")
                        .WithMany("Details")
